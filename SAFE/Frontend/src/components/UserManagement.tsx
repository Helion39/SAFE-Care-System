    ...
    <div className="flex flex-col gap-3">
      ...
      <div className="grid grid-3">
        <div className="metric-card-refined metric-card-info">
          <div className="metric-label-top">Total Caregivers</div>
        ...
        <div className="metric-card-refined metric-card-success">
          <div className="metric-label-top">Active Caregivers</div>
          <div className="metric-content">
            ...
            <UserCheck className="metric-icon-small" />
          </div>
        </div>
        
        <div className="metric-card-refined metric-card-warning">
          <div className="metric-label-top">Inactive Caregivers</div>
          <div className="metric-content">
            ...
            <UserX className="metric-icon-small" />
          </div>
        </div>
      </div>

      {/* Caregiver List with Search and Filter */}
      <div style={{ 
